...
├── mechanics_compute.py         # MechanicsRecord dataclass, trajectory mechanics computation
...
- Project root cleanup — reorganising top-level files into subdirectories as the
  module count grows
